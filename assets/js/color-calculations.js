 ...
 * @return {Object} - this
 */
function _twinstarColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_twinstarColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_twinstarColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_twinstarColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _twinstarColor object.
 *
 * @since Twin Star 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function twinstarColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _twinstarColor( backgroundColor, accentHue );
